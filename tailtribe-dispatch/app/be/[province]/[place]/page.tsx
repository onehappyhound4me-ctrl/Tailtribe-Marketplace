...
const SERVICE_SECTIONS = [
  ...
  { id: 'GROUP_DOG_WALKING', name: 'Groepsuitlaat', slug: 'groepsuitlaat' },
  { id: 'DOG_TRAINING', name: 'Hondentraining', slug: 'hondentraining' },
  { id: 'PET_SITTING', name: 'Dierenoppas', slug: 'dierenoppas' },
  { id: 'CAT_SITTING', name: 'Kattenoppas', slug: 'kattenoppas' },
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = focus
    ? `Hondenuitlaat, groepsuitlaat en dierenoppas in ${place.name} | TailTribe`
...
export default function PlaceLandingPage({ params }: Props) {
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      ...
      {
        '@type': 'Question',
        name: 'Hoe werkt een groepsuitlaat?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Bij een groepsuitlaat gaat je hond mee met een kleine, zorgvuldig samengestelde groep sociale honden. We stemmen vooraf karakter, energie en praktische zaken af en voorzien voldoende rustmomenten en veilige wandelroutes.',
        },
      },
      {
        '@type': 'Question',
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'In deze regio kun je onder meer terecht voor hondenuitlaat, groepsuitlaat, hondentraining, dierenoppas, dierenopvang, verzorging aan huis, transport van huisdieren en – waar van toepassing – verzorging van boerderijdieren en begeleiding tijdens events.',
        },
      },
    ],
  }
        ...
        <div className="max-w-4xl mx-auto">
              ...
              {SERVICE_SECTIONS.map((service) => (
                <div key={service.id} className="border-t border-emerald-50 pt-5 first:border-t-0 first:pt-0">
                  ...
                  {service.id === 'GROUP_DOG_WALKING' ? (
                    <p className="text-gray-700 leading-relaxed">
                      Bij groepsuitlaat gaat je hond mee met een kleine, zorgvuldig samengestelde groep sociale honden
          ...
          <section className="bg-white rounded-2xl shadow-sm border border-black/5 p-8 mt-6">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <div>
                <div className="font-semibold text-gray-900">Hoe werkt een groepsuitlaat?</div>
                <p>
                  Bij een groepsuitlaat gaat je hond mee met een zorgvuldig geselecteerde groep sociale honden. We
              ...
              <div>
                ...
                <p>
                  In deze regio kun je onder andere terecht voor hondenuitlaat, groepsuitlaat, hondentraining,
