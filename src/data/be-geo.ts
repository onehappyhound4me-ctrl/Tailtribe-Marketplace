...
const antwerpenPlaces: BEPlace[] = [
  ...
  { name: "Hoogstraten", slug: "hoogstraten", lat: 51.4000, lng: 4.7597 },
...
const oostVlaanderenPlaces: BEPlace[] = [
  ...
  { name: "Aalst", slug: "aalst", lat: 50.9370, lng: 4.0435 },
...
const westVlaanderenPlaces: BEPlace[] = [
  ...
  { name: "Kortrijk", slug: "kortrijk", lat: 50.8281, lng: 3.2650 },
  { name: "Roeselare", slug: "roeselare", lat: 50.9481, lng: 3.1269 },
  { name: "Ieper", slug: "ieper", lat: 50.8519, lng: 2.8850 },
...
// Get popular provinces for footer links
export const getPopularProvinces = () => [
  "antwerpen",
  "oost-vlaanderen", 
  "vlaams-brabant",
  "brussel",
