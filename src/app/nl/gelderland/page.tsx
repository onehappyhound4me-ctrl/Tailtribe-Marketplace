...
export const metadata: Metadata = {
  title: 'Dierenoppas Gelderland - Nijmegen, Arnhem, Apeldoorn',
  description: 'Vind betrouwbare dierenoppassers in Gelderland. Hondenuitlaat en dierenoppas in Nijmegen, Arnhem, Apeldoorn en omgeving.',
}

export default function GelderlandPage() {
  const cities = [
    'Nijmegen', 'Arnhem', 'Apeldoorn', 'Ede', 'Doetinchem',
    'Harderwijk', 'Wageningen', 'Barneveld', 'Tiel'
  ]
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Dierenoppassers in Gelderland
            </h1>
            <p className="text-xl text-gray-600">
              Van Nijmegen tot Apeldoorn, vind de perfecte dierenoppasser bij jou in de buurt
            </p>
          </div>
