...
export const metadata: Metadata = {
  title: 'Dierenoppas Noord-Brabant - Eindhoven, Tilburg, Breda',
  description: 'Vind betrouwbare dierenoppassers in Noord-Brabant. Hondenuitlaat en dierenoppas in Eindhoven, Tilburg, Breda en omgeving.',
}

export default function NoordBrabantPage() {
  const cities = [
    'Eindhoven', 'Tilburg', 'Breda', '\'s-Hertogenbosch', 'Helmond',
    'Oss', 'Bergen op Zoom', 'Roosendaal', 'Veghel'
  ]
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Dierenoppassers in Noord-Brabant
            </h1>
            <p className="text-xl text-gray-600">
              Van Eindhoven tot Breda, vind de perfecte dierenoppasser bij jou in de buurt
            </p>
          </div>
