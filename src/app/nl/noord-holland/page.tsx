...
export const metadata: Metadata = {
  title: 'Dierenoppas Noord-Holland - Amsterdam, Haarlem, Zaanstad',
  description: 'Vind betrouwbare dierenoppassers in Noord-Holland. Hondenuitlaat en dierenoppas in Amsterdam, Haarlem, Zaanstad en omgeving.',
}

export default function NoordHollandPage() {
  const cities = [
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Dierenoppassers in Noord-Holland
            </h1>
            <p className="text-xl text-gray-600">
              Van Amsterdam tot Alkmaar, vind de perfecte dierenoppasser bij jou in de buurt
            </p>
          </div>
